...
import java.util.Scanner;
 ...
 class App {
    public static <CeaseCipher> void main(String[] args) {
        ...
        CeaseCipher ceaserCipher = new CeaseCipher(password,key);
        String encryption = ceaserCipher.cipher();
        System.out.println("Encrypted:\t" + encryption);

        //decryption
        CeaseCipher ceaserCipherDec = new CeaseCipher(encryption,-key);
